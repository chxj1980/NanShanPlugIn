// DHPlayPlugin.cpp : 定义 DLL 的初始化例程。
//

#include "stdafx.h"
#include "DHPlayPlugin.h"
...
CDHPlayPluginApp::CDHPlayPluginApp()
{
	...
	InitializeCriticalSection(&DHPlayHandle::m_Lock);
}


// 唯一的一个 CDHPlayPluginApp 对象

CDHPlayPluginApp theApp;


// CDHPlayPluginApp 初始化
...
int CDHPlayPluginApp::ExitInstance()
{
	...
	DeleteCriticalSection(&DHPlayHandle::m_Lock);
