...
public:
    ...
    ICE_DEPRECATED_API virtual void createObject(const ::Ice::Identity&, const ::Ice::ObjectPtr&) = 0;

    ICE_DEPRECATED_API virtual void destroyObject(const ::Ice::Identity&) = 0;
};
