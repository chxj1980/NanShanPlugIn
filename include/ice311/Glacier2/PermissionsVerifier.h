...
public:
    ...
    {
	return checkPermissions(userId, password, reason, __defaultContext());
    }
...
public:
    ...
    {
	return authorize(info, reason, __defaultContext());
    }
...
public:
    ...
    ::IceInternal::DispatchStatus ___checkPermissions(::IceInternal::Incoming&, const ::Ice::Current&) const;
...
void GLACIER2_API __patch__PermissionsVerifierPtr(void*, ::Ice::ObjectPtr&);
...
public:
    ...
    ::IceInternal::DispatchStatus ___authorize(::IceInternal::Incoming&, const ::Ice::Current&) const;
...
void GLACIER2_API __patch__SSLPermissionsVerifierPtr(void*, ::Ice::ObjectPtr&);
